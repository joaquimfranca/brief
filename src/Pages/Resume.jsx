...
import obbjeto from "../images/obbjeto.png";
        ...
        <article>
          <div className="sumary">
            ...
            <div className="skills">
              <h1>Skills</h1>
              <p>
                 <b>  - JavaScript  - TypeScript    - React   - HTML 5  
              <br />
                   - Bootstrap    - CSS3   -   Sass - User Interface/User Experience
              <br />
                    - Node.js  - API REST - MYSQL - PHP
                </b>
              </p>
            </div>
            <div className="experience">
              ...
              <div className="back-topic">
                <div className="container-topic">
                  <div className="head-topic">
                    <h2>Desenvolvimento e-Commerce | Pet Shop Amarelo</h2>
                    <h3>
              ...
              <div className="back-topic">
                <div className="container-topic">
                  <div className="head-topic">
                    <h2>Desenvolvimento Web/e-Commerce | Obbjeto</h2>
                    <h3>
                      <b>Desenvolvedor Front-end.</b> Junho de 2023 - Atualmente
                    </h3>
                  </div>
                  <div className="img-topic">
                    <img src={obbjeto}></img>
                ...
                <span>
                Como Engenheiro Front End Pleno, sou responsável 
                por criar as aplicações web e desenvolver o sistema de gestão da empresa. 
                Usando React para parte web e Delphi no sistema de gestão.
                </span>
              </div>
            </div>
