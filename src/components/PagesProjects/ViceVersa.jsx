    ...
    <section>
      <div>
        <ProjectPages
          ...
          img4={img4}
          title={"Vice Versa"}
          description="Nesse projeto de capa de álbum fizemos uma arte conceitual,
           a proposta do artista era uma vibe psicodélica, onde as canções abordavam muito 
           o tema ''localidade'', então fizemos uma distorção de uma fotografia que nos foi 
